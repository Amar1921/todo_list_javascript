...
const storage = new ArrayStorage('tasks'); // On récupère le tableau des tâches déjà existantes ou bien un tableau vide

const tasks = storage.list; // Une fonction qui ajoute les tâches au DOM avec un bouton de suppression auquel on attache un évènement
...
tasks.forEach(task => taskToDOM(task)); // On gère l'ajout de tâche avec le bouton ADD et la touche 'Enter'
